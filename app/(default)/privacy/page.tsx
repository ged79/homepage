        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          <div className="py-16 lg:py-24">
            ...
            <div className="pb-10">
              ...
              <p className="mt-3 text-slate-500">시행일: 2025년 1월 1일</p>
            </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-8 md:p-12">
                <div className="max-w-none">
                  <p className="text-slate-600 mb-6">
                    코넥서스(이하 "회사")는 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 
                    이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침을 수립·공개합니다.
                  </p>

                  <h2 className="text-xl font-bold text-slate-900 mb-4">제1조 (개인정보의 처리목적)</h2>
                  <p className="text-slate-600 mb-6">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제2조 (개인정보의 처리 및 보유기간)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제3조 (처리하는 개인정보의 항목)</h2>
                  <p className="text-slate-600 mb-6">회사는 다음의 개인정보 항목을 처리하고 있습니다.</p>
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제4조 (개인정보의 제3자 제공)</h2>
                  <p className="text-slate-600 mb-6">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제5조 (개인정보처리의 위탁)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                    <li>1. 회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다:</li>
                    <li className="ml-4">• 수탁업체: 클라우드 호스팅 서비스 (Netlify, Vercel 등)</li>
                    <li className="ml-4">• 위탁업무: 웹사이트 호스팅 및 데이터 보관</li>
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제6조 (정보주체와 법정대리인의 권리·의무 및 행사방법)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제7조 (개인정보의 파기)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제8조 (개인정보의 안전성 확보조치)</h2>
                  <p className="text-slate-600 mb-6">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제9조 (개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제10조 (개인정보보호책임자)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                    ...
                    <li className="ml-4">• 연락처: 010-7741-4569, conexus25@conexus.co.kr</li>
                    <li>2. 정보주체는 회사의 서비스를 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보보호책임자에게 문의하실 수 있습니다.</li>
                  </ul>

                  <h2 className="text-xl font-bold text-slate-900 mb-4">제11조 (개인정보 열람청구)</h2>
                  <p className="text-slate-600 mb-6">
                  ...
                  <ul className="text-slate-600 mb-6 space-y-2">
                    ...
                    <li>• 연락처: 010-7741-4569, conexus25@conexus.co.kr</li>
                  </ul>

                  <h2 className="text-xl font-bold text-slate-900 mb-4">제12조 (권익침해 구제방법)</h2>
                  <p className="text-slate-600 mb-6">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제13조 (영상정보처리기기 운영·관리에 관한 사항)</h2>
                  <p className="text-slate-600 mb-6">
                    회사는 영상정보처리기기를 설치·운영하지 않습니다.
                  </p>

                  <h2 className="text-xl font-bold text-slate-900 mb-4">제14조 (개인정보처리방침의 변경)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
