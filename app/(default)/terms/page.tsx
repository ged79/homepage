              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-8 md:p-12">
                <div className="max-w-none">
                  ...
                  <p className="text-slate-600 mb-6">
                    본 약관은 코넥서스(이하 "회사")가 제공하는 웹/앱 개발, 플랫폼 구축 및 관련 IT 서비스(이하 "서비스")의 이용과 관련하여 
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제4조 (서비스의 제공)</h2>
                  <p className="text-slate-600 mb-2">회사가 제공하는 서비스는 다음과 같습니다:</p>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제5조 (계약의 성립)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제6조 (서비스 대금 및 지급방법)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제7조 (이용자의 의무)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제8조 (회사의 의무)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제9조 (저작권 및 지적재산권)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제10조 (프로젝트 변경 및 추가 요청)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제11조 (하자보수)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제12조 (손해배상)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제13조 (계약 해지)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제14조 (비밀유지)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제15조 (면책조항)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제16조 (분쟁 해결)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <h2 className="text-xl font-bold text-slate-900 mb-4">제17조 (기타)</h2>
                  <ul className="text-slate-600 mb-6 space-y-2">
                  ...
                  <div className="mt-12 pt-8 border-t border-slate-200">
                    <h3 className="text-lg font-bold text-slate-900 mb-4">부칙</h3>
