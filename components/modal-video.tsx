  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        data-aos-delay={200}
      >
        <figure className="relative w-full overflow-hidden rounded-2xl" style={{ aspectRatio: '1104 / 576' }}>
          {/* Blur edge overlay */}
          <div className="absolute inset-0 z-10 pointer-events-none">
            <div className={`absolute inset-x-0 top-0 h-32 bg-gradient-to-b ${isDarkMode ? 'from-gray-950' : 'from-white/80'} to-transparent`} />
            <div className={`absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t ${isDarkMode ? 'from-gray-950' : 'from-white/80'} to-transparent`} />
            <div className={`absolute inset-y-0 left-0 w-32 bg-gradient-to-r ${isDarkMode ? 'from-gray-950' : 'from-white/80'} to-transparent`} />
            <div className={`absolute inset-y-0 right-0 w-32 bg-gradient-to-l ${isDarkMode ? 'from-gray-950' : 'from-white/80'} to-transparent`} />
          </div>
          <Image
            className={isDarkMode ? "grayscale brightness-120" : ""}
            src={thumb}
            width={2248}
            height={2448}
            priority
          ...
          <div className="absolute inset-0 z-5" style={{
            boxShadow: isDarkMode 
              ? 'inset 0 0 100px 50px rgba(15, 23, 42, 0.9)'
              : 'inset 0 0 80px 40px rgba(255, 255, 255, 0.6), inset 0 0 120px 60px rgba(238, 242, 255, 0.4)'
          }} />
        </figure>
        {/* Play icon */}
